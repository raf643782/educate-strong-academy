...
async function main() {
  ...
  const eventDefs = [
    ...
    },
    {
      ...
      technicalNotes: 'Each pillar is chained to a handle held by the athlete. Competition pillar weights vary significantly by event; there is no fixed time limit or target, and the clock runs until the athlete can no longer support both pillars.',
    ...
    },
    {
      ...
      category: 'Loading Events',
      description: "Fingal's Fingers is a strongman flipping event. A series of five hinged poles, each heavier and longer than the last, must be lifted from a horizontal resting position and flipped fully onto the opposite side, one after another, against the clock.",
    ...
    },
    {
      ...
      technicalNotes: 'Most commonly run as a medley of several blocks of ascending weight, pressed in succession within a set time limit, scored by total blocks or reps completed, or by the heaviest single block locked out in a max-single format. Competition weight ranges and time limits vary by promoter.',
