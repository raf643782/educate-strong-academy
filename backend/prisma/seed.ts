...
async function main() {
  ...
  const eventDefs = [
    ...
    // ── New Press Events ──────────────────────────────────────────────────────
    {
      ...
      category: 'Press Events',
      description: 'A large single-arm dumbbell cleaned to one shoulder and pressed overhead. One of the most technically demanding overhead events, requiring unilateral shoulder strength and controlled shouldering mechanics. Contested as a max attempt, for reps, or as part of an overhead medley.',
      technicalNotes: 'Clean the dumbbell to one shoulder in a single controlled motion or via the lap. Stabilise the shoulder position before pressing. Press overhead to a stacked lockout — elbow directly under the load. The non-working arm may be used for balance but must not assist the press. Exact shoulder position and finish standards vary between competitions.',
      coachingNotes: 'Train the clean and the press as separate skill problems. Key coaching points: clean the dumbbell to a high shoulder position; settle before pressing; keep the elbow under the load; the free arm is for balance only. Build unilateral shoulder stability through kettlebell clean and press progressions before introducing competition-weight dumbbells.',
      ...
      programmingNotes: 'Use sparingly due to high technical and fatigue demand. Pair with bilateral overhead pressing work throughout the training year. Programme specifically when the circus dumbbell is a named event in a competition.',
      commonErrors: 'Pressing before the dumbbell is settled on the shoulder; leaning excessively to the working side; using the free hand to assist the press; elbow drifting out from under the load at lockout.',
      isPublished: true,
      isLaunchPriority: false,
    },
    {
      ...
      programmingNotes: 'Good for building overhead volume without the clean fatigue of log or axle. Can substitute for one overhead session per week in a competition preparation block.',
      commonErrors: 'Drifting backward and losing the line of force; incomplete lockout on later repetitions; holding breath across multiple reps; rushing the reversal at the bottom of each rep.',
      isPublished: true,
      isLaunchPriority: false,
    },
    // ── New Deadlift Events ───────────────────────────────────────────────────
    {
      ...
      slug: 'axle-deadlift',
      category: 'Deadlift Events',
      description: 'Deadlifting with a thick, non-revolving axle bar. The elimination of bar rotation significantly increases grip demand. Contested as a max single, a 3-rep max, or for repetitions in a time cap.',
      technicalNotes: 'Set-up is similar to conventional deadlift — feet hip-width, bar over mid-foot, hip hinge to the bar. The thicker diameter requires deliberate attention to grip. The axle does not flex at the start of a heavy pull as a conventional barbell would. Straps may or may not be permitted depending on competition rules — confirm before each event.',
      coachingNotes: 'Key coaching points: squeeze the axle hard before initiating; push the floor away as in a conventional deadlift; bar stays close to the legs throughout; full lockout. Grip capacity is often the limiting factor for new axle users — build thick-bar tolerance with regular axle work and static holds throughout the training year.',
      ...
      programmingNotes: 'Substitute axle for standard barbell on some deadlift sessions to build specific grip and pull tolerance. Athletes who are strong on the axle deadlift typically find the continental clean easier to develop. Grip accessories: thick bar static holds, rolling thunder variations.',
      commonErrors: 'Grip failure before lockout; bar drifting forward due to changed bar diameter; not achieving full lockout; rushing the set-up.',
      isPublished: true,
      isLaunchPriority: false,
    },
    {
    ...
    // ── New Carry Events ──────────────────────────────────────────────────────
    {
      ...
      slug: 'frame-carry',
      category: 'Carry Events',
      description: 'Carrying a large rectangular frame by its side handles for a set distance. Demands grip security, upper back stability, and control of a wide-stance carry with loading at the sides.',
      technicalNotes: 'Position inside the frame with both hands on the side handles. Establish an even grip before initiating the pick — both sides must rise together. Walk with short, controlled strides. Brace the core and resist lateral lean. Handle heights and widths vary between apparatus designs — adjust the start position accordingly.',
      coachingNotes: 'Key coaching points: even grip before the pick; squeeze then stand; both sides rise together; resist lateral lean throughout the carry; short consistent steps. Grip security is often the limiting factor. Practise the re-pick if drops are permitted in the competition — many athletes lose time here.',
      ...
      programmingNotes: "Farmer's walk strength and grip work transfer well. Include frame-specific work in the final preparation block when it is a named event. Static holds at competition-width handles are the most specific grip preparation.",
      commonErrors: 'Uneven pick causing one side to drop; overstriding and losing frame stability; grip failure before the carry is complete; lateral lean increasing under fatigue.',
      isPublished: true,
      isLaunchPriority: false,
    },
    {
      ...
      slug: 'husafell-carry',
      category: 'Carry Events',
      description: 'A front-loaded carry where the athlete hugs a heavy stone, sandbag, or shield against the chest and carries it for distance. Tests core strength, upper back endurance, and breathing management under a compressive front load.',
      technicalNotes: 'Secure the object high on the chest — forearms and biceps cradle the load, elbows tucked underneath. Brace the core and maintain an upright posture. Short, controlled strides. Breathing is restricted by the front load — exhale steadily and breathe shallowly but consistently. Contact rules vary between competitions.',
      coachingNotes: 'Key coaching points: carry the object high on the chest, not at the waist; elbows under the object; upright posture prevents lower back strain; short consistent steps. The breathing restriction is the most underestimated challenge — introduce this carry type progressively with new athletes.',
      ...
      programmingNotes: 'Direct preparation for Husafell stone, shield carry, and similar front-loaded events. Front squat strength transfers well to the positional demands. Bear hug sandbag carries are an accessible training alternative.',
      commonErrors: 'Carrying the object too low, increasing lower back strain; leaning backward to counterbalance; not bracing, allowing the load to compress the trunk; dropping due to breathing management failure.',
      isPublished: true,
      isLaunchPriority: false,
    },
    // ── New Loading Events ────────────────────────────────────────────────────
    {
      ...
      category: 'Loading Events',
      description: 'Lifting an atlas stone from the floor and fixing it to one shoulder. Requires the full atlas stone lapping pattern followed by an explosive rotation phase to seat the stone on the shoulder. More technically demanding than platform loading.',
      technicalNotes: 'Complete the stone-to-lap phase before attempting the rotation. With the stone in the lap, use hip drive and a controlled shrug rotation to transfer the stone to the shoulder. The shoulder catch must be stable. Rules on valid shoulder position and settle requirements vary between competitions.',
      coachingNotes: 'Key coaching points: never rush the lap phase; the rotation is initiated by hip drive, not arm strength; the shoulder must be square and ready to receive the stone. Build the lap and rotation as separate skill phases in early training. Start with lighter or natural stones before competition weight.',
      ...
      commonErrors: 'Rushing from the floor without a solid lap position; rotating with arms before hip drive; unstable shoulder catch; overrotating and losing the stone.',
      isPublished: true,
      isLaunchPriority: false,
    },
    {
    ...
    },
    {
      ...
      slug: 'power-stairs',
      category: 'Loading Events',
      description: 'Lifting a series of heavy objects up a stair apparatus one step at a time. Tests explosive leg and hip drive, pulling strength, and the ability to perform repeated near-maximal efforts under accumulating fatigue.',
      technicalNotes: 'Lift each implement from its resting position using a controlled pattern appropriate to the object type. Drive the object to the next step with hip extension and leg drive. Reset the feet before initiating each step. Own each pick before moving to the next.',
      coachingNotes: 'Key coaching points: own the first pick — never rush it; chest up and drive through the legs; reset feet between steps; control the reset and breathe briefly. Athletes who fail at power stairs often lose position on the later objects, not the first — programme for accumulated fatigue.',
      ...
      programmingNotes: 'Programme when power stairs is a named event. Conventional deadlift and block pull strength transfers directly. High quad and hip demand — front squat and leg press are useful accessories.',
      commonErrors: 'Not completing the previous step cleanly before loading the next; carrying the implement too far from the body; rushing and losing position under fatigue; failing to reset feet between steps.',
      isPublished: true,
      isLaunchPriority: false,
    },
  ];
  ...
  const exerciseDefs = [
    ...
    // ── Additional Deadlift / Hinge ───────────────────────────────────────────
    {
      ...
      category: 'Deadlift / Hinge',
      difficulty: Difficulty.INTERMEDIATE,
      description: 'Deadlifting with a thick, non-revolving axle bar. The elimination of bar rotation significantly increases grip demand. A common competition event format as a max single, 3-rep max, or for repetitions in a time cap.',
