...
- **`nutrition-conversations-with-athletes`** is missing its `scopeOfPracticeNote` disclaimer — every other FREE article has one, this one has `null`. See the recommended correction in the Priority 3 report.
