/**
 * Reusable FAQ accordion for Knowledge Hub articles. Renders a Sanity
 * `faq` array (question/answer pairs). No existing FAQ component was
 * found elsewhere in the codebase, so this is new.
 */
