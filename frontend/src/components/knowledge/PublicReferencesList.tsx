/**
 * Renders `publicReferences` — public-safe citations for a Sanity Knowledge
 * Hub article. This is a separate, plain-object field, not Portable Text,
 * so it does not go through PortableTextRenderer.
 */
