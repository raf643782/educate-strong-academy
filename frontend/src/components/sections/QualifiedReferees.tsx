      ...
      <div className="es-container py-16 md:py-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            >
              <img src="/assets/partner-british-army.webp" alt="British Army" className="h-6 w-auto opacity-80" loading="lazy" onError={(e) => { (e.target as HTMLImageElement).src = '/assets/british-army-logo.webp'; }} />
              <div>
