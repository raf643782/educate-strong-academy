/**
 * TutorCredibilityPreview — preview-only rewrite of the tutor section.
 *
 * Reuses the real tutor photos already in /public/assets (unchanged
 * from production). Copy is rewritten so Paul Smith receives the
 * first, most detailed mention (measured search interest around his
 * name is the strongest existing organic asset connected to the
 * domain), while the other four tutors keep real, specific credentials
 * rather than a vague group credit. Only achievements already present
 * on the live site are used; nothing here is invented.
 */
...
export default function TutorCredibilityPreview() {
  return (
    <section
